...
#### Still Missing:
At this point, we need to create weight matrices. For each group (high vs. low climate change conspiracy belief) we need a separate matrix. 


#### Test Area. Caution: Please be aware of falling objects! Don't forgert your safety helmet! 
...
* k-cliques = fully connected networks with _k_ nodes. The smallest possible k would be k=3. Otherwise, the cliques would be only edges.
