---
title: "Data Preperation File for t2 CAM study (samples from USA, Germany) - second step rename single concepts, split data sets"
author: "Julius Fenn"
format:
  html:
    toc: true
...
vroom::vroom_write(x =  CAMfiles[[2]], file = "CAM_connectors_clean.txt")
vroom::vroom_write(x =  CAMfiles[[3]], file = "CAM_merged_clean.txt")
```
