...
# CAMfiles[[2]][["isBidirectional"]] <- 1
# CAMfiles[[3]][["isBidirectional"]] <- 1
...
setwd("outputs")
write.table(adjacency_matrix_high, file = "adjacency_matrix_high.csv",
...
partition_high <- leiden(adjacency_matrix_high, resolution_parameter = 1)
...
partition_low <- leiden(adjacency_matrix_low, resolution_parameter = 1)
table(partition_low)
