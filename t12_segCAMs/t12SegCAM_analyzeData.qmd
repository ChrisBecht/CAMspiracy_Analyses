...
```{r}
partition <- leiden::leiden(object = graph_object, resolution_parameter = 1.301275459001395) # enter gamma as resolution_parameter
...
# Cutoff: Use only concepts that are connected with other concepts at least 4 times. 
rows_to_keep <- which(rowSums(adjacency_matrix_high) > 3)
...
partition <- leiden::leiden(object = graph_object, resolution_parameter = 1.0181890843352919)
