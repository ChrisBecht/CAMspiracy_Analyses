...
rm(protocolDataset, consider_Protocol, text)
```
...
- num_nodes_pos_macro           
- num_nodes_neg_macro           
- num_nodes_neut_macro          
- num_nodes_ambi_macro          
...
netIndicators_overall <- compute_indicatorsCAM(drawn_CAM = CAMdrawn_overall)
```
...
# number of concepts
t.test(netIndicators_high$num_nodes_macro~netIndicators_low$num_nodes_macro, var.equal = FALSE, alternative = "two.sided")


wilcox.test(netIndicators_high$num_nodes_macro~netIndicators_low$num_nodes_macro, 
            exact = FALSE, 
            correct = FALSE, 
            conf.int = FALSE)
