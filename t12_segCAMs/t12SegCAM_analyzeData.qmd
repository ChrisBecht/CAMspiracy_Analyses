...
## check for symmetry
all(colSums(CAMaggregated[[5]][[1]]) == rowSums(CAMaggregated[[5]][[1]]))


## test first concept of first CAM
colnames(CAMaggregated[[5]][[1]])[1]
colnames(CAMaggregated[[5]][[1]])[CAMaggregated[[5]][[1]][1, ] >= 1]
rownames(CAMaggregated[[5]][[1]])[CAMaggregated[[5]][[1]][1, ] >= 1]
...
CAMaggregated_onlyOnes <- CAMaggregated[[5]]
for(i in 1:length(CAMaggregated_onlyOnes)){
  CAMaggregated_onlyOnes[[i]][CAMaggregated_onlyOnes[[i]] >= 1] <- 1
}
```
