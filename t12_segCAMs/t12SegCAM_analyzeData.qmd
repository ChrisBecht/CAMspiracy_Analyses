...
### CAMs from Germany | not necessary
```{r}
setwd("outputs")
...
```{r}
CAMwordlist_high <- CAMwordlist_high[c(1:7)]
CAMwordlist_low <- CAMwordlist_low[c(1:7)]
...
CAMwordlist_overall <- merge(CAMwordlist_high, CAMwordlist_low, by = "Words")
